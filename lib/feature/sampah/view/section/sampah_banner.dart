...
class SampahBanner extends StatefulWidget {
  const SampahBanner({Key? key}) : super(key: key);

  @override
  State<SampahBanner> createState() => SampahBannerState();
}

class SampahBannerState extends State<SampahBanner> {
  @override
