...
class MitraBanner extends StatefulWidget {
  const MitraBanner({Key? key}) : super(key: key);

  @override
  State<MitraBanner> createState() => MitraBannerState();
}

class MitraBannerState extends State<MitraBanner> {
  @override
